...
{
    switch (((GLWindow*)self.view.window).windowType) {
...
{
    WKWebView* webView = [[GLWebView alloc]
        initWithFrame: frame
...
- (WKWebViewConfiguration*)buildConfig
{
    ...
    // geolocation
    [ucController
        addScriptMessageHandler: [[GLLocation alloc] init]
        name: @"geolocation"
    ];
    ...
    [ucController addScriptMessageHandler: self name: @"gailan"];
